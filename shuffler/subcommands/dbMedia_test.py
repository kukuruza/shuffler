...
from shuffler.subcommands import dbMedia
from shuffler.subcommands import dbModify
...
class Test_cropObjects_carsDb(testUtils.Test_carsDb):
    ...
    @mock.patch('shuffler.subcommands.dbMedia.backendMedia.MediaWriter')
...
class Test_cropObjects_SyntheticDb(unittest.TestCase):
    ...
    @mock.patch('shuffler.subcommands.dbMedia.utilBoxes.cropPatch')

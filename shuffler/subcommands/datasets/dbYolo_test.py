...
from shuffler.subcommands.datasets import dbYolo
from shuffler.utils import testUtils


class Test_dbExportYolo_carsDb(testUtils.Test_carsDb):
    def setUp(self):
        super(Test_dbExportYolo_carsDb, self).setUp()
        self.temp_dir = op.join(tempfile.gettempdir(), 'Test_dbExportYolo')
        assert not op.exists(self.temp_dir)
        os.mkdir(self.temp_dir)

    def tearDown(self):
        super(Test_dbExportYolo_carsDb, self).tearDown()

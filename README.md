...
./pipeline.py \
  importPictures --image_pattern "path/to/imagedir/*.jpg" --mask_pattern "path/to/labeldir/*.png" \
  writeVideo \
    --out_videopath ~/datasets/scotty/4096x2160_5Hz__2018_6_7_18_57_38_masked.avi \
    --labelmap_file /path/to/labelmap.json \
    --fps 1
```
...
PRED_DIR=/home/evgeny/src/MCD_DA/segmentation/test_output/gta-images2scotty-train_3ch---scotty-test/MCD-normal-drn_d_105-1.tar
PRED_LABELMAP_PATH=/home/evgeny/datasets/GTA5/labelmap_GTA5.json
./pipeline.py \
  importPictures --image_pattern=${GT_DIR}/*.jpg --mask_pattern=${PRED_DIR}/label/*.png \
